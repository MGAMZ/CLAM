...
def seg_and_patch(
    ...
    # NOTE MGAM 2025.01.09: Add filter for svs files.
    slides = sorted(os.listdir(source))
    slides = [slide 
              for slide in slides 
              if os.path.isfile(os.path.join(source, slide)) \
              and slide.endswith(".svs")]
    # NOTE MGAM 2025.01.09: Corrupted file.
    slides.remove("AR096-HE-MBM400.svs")
    ...
    for i in tqdm(range(total)):
        ...
        try:
            ...
            raise RuntimeError("Error loading slide {}".format(full_path)) from e
